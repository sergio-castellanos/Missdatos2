...
if (!empty($_POST["btnregistrar"])){
    if (!empty($_POST["identificacion"]) and !empty($_POST["nombre_completo"]) and !empty($_POST["fecha_nacimiento"]) and !empty($_POST["direccion"]) and !empty($_POST["telefono"]) and !empty($_POST["cargo"]) and !empty($_POST["correo"])){
        ...
        $sql=$conn->query(" insert into empleado(identificacion,nombre_completo,fecha_nacimiento,direccion,telefono,cargo,correo)values('$identificacion','$nombre_completo','$fecha_nacimiento','$direccion','$telefono','$cargo','$correo')");
