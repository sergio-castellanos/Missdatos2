    ...
    while($datos = $sql->fetch_object()) { ?>
     <tr>
      ...
      <td>
        ...
        <td><a onclick="return eliminar()" href="incapacidades_e.php?id_incapacidad=<?= $datos->id_incapacidad?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
