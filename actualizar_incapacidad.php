...
$sql=$conexion->query (" select * from incapacidad where id_incapacidad=$id_incapacidad");
?>
...
<html lang="en">
    ...
    <h3 class="text-center text-secundary ">Actualizar Incapacidad</h3>
    <input type="hidden" name="id_incapacidad" velue="<?= $_GET["id_incapacidad"] ?>">
    <?php
include "actualizar_i.php";
...
<div class="mb-1">
  ...
  <button type="submit" class="btn btn-primary" name="btnactualizari" value="ok">Actualizar empleado</button>
